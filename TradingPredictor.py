...
class TradingPredictor:
    """
    A class for predicting trading performance using ESG metrics.
    """

    def __init__(self, db_file, table_name, numerical_features, categorical_features, target):
        """
        Initializes a TradingPredictor object.

        Parameters:
            db_file (str): The name of the database file containing the trading data.
            table_name (str): The name of the table containing the trading data.
